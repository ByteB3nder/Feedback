    ...
    public class FeedbackUI : MonoBehaviour
    {
        ...
        public void SendFeedback()
        {
            ...
            string content = contentText.text +
                             $" Additional info - Priority: {priorityDropdown.value} Category: {categoryDropdown.value}";
            
            feedbackSender.SendFeedbackToTrello(header, content, OnFeedBackSent, OnFeedBackFailed, panel);
        }
    }
}